...
def MNIST(dataroot, train_aug=False):
    ...
    train_dataset = CacheClassLabel(train_dataset, "MNIST")
    ...
    val_dataset = CacheClassLabel(val_dataset, "MNIST")
...
def CIFAR10(dataroot, train_aug=False):
    ...
    train_dataset = CacheClassLabel(train_dataset, "CIFAR10")
    ...
    val_dataset = CacheClassLabel(val_dataset, "CIFAR10")
...
def CIFAR100(dataroot, train_aug=False):
    ...
    train_dataset = CacheClassLabel(train_dataset, "CIFAR100")
    ...
    val_dataset = CacheClassLabel(val_dataset, "CIFAR100")
